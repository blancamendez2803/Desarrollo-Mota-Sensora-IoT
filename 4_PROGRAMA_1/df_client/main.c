                                             ...
                                             esp_ble_mesh_model_cb_param_t *param)
{
    ...
    case ESP_BLE_MESH_MODEL_OPERATION_EVT:
        if (param->model_operation.opcode == ESP_BLE_MESH_VND_MODEL_OP_STATUS) {
            ...
            ESP_LOGI(TAG, "Recv 0x%" PRIx32 "", param->model_operation.opcode);
    ...
    case ESP_BLE_MESH_MODEL_SEND_COMP_EVT:
        if (param->model_send_comp.err_code) {
            ...
            //ESP_LOGE(TAG, "Failed to send message 0x%" PRIx32 "err: %04x", param->model_send_comp.opcode, param->model_send_comp.err_code);
            break;
        }
    ...
    case ESP_BLE_MESH_CLIENT_MODEL_RECV_PUBLISH_MSG_EVT:
        ...
        //ESP_LOGI(TAG, "Receive publish message1 0x%" PRIx32, param->client_recv_publish_msg.opcode);
        break;
